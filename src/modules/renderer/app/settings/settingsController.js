...
const SETTINGS_MODAL_META = Object.freeze({
    ...
    profile: {
        title: '学习档案',
        subtitle: '管理学生姓名、城市、年级以及少量自定义提示词变量。',
    },
    prompts: {
        title: '气泡渲染',
    ...
    emoticons: {
        title: '表情包设置',
        subtitle: '单独管理表情包提示和可用表情资源的注入方式。',
    },
    'ai-memory': {
        title: 'AI日记记忆',
        subtitle: '集中管理 DailyNote 协议、AI 日记写入和长期记忆相关开关。',
    },
    assist: {
        title: '对话辅助',
        subtitle: '集中管理追问生成和自动命名话题这两类对话后处理能力。',
    },
    'prompt-advanced': {
        title: '高级与调试',
...
const DEFAULT_AGENT_BUBBLE_THEME_PROMPT = `当前真实时间：{{CurrentDateTime}}。

Output formatting requirement: ${DEFAULT_RENDERING_PROMPT}
...
function renderModelServiceProviderList(service = getNormalizedModelService()) {
    ...
    function switchSettingsModalSection(section) {
        ...
        const sections = [
            ...
            ['profile', el.settingsModalSectionProfile],
            ['prompts', el.settingsModalSectionPrompts],
            ['emoticons', el.settingsModalSectionEmoticons],

...
function createContentCatalog(ops) {
    return {
        ...
        getKnowledgeBaseShelfLinks: query((documentIds) => ops.invoke('kb:get-shelf-links', documentIds)),
        addKnowledgeBaseDocumentsToShelf: query((documentIds, options) => ops.invoke('kb:add-documents-to-shelf', documentIds, options)),
        moveKnowledgeBaseDocumentToShelfGroup: query((documentId, targetKbId) => ops.invoke('kb:move-document-to-shelf-group', documentId, targetKbId)),
        ...
        getKnowledgeBaseDocumentThumbnail: query((documentId) => ops.invoke('kb:get-document-thumbnail', documentId)),

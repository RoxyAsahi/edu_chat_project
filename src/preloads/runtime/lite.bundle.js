...
function createSessionCatalog(ops) {
    return {
        ...
        sendChatRequest: query((request) => ops.invoke('send-chat-request', request)),
        ...
        onChatStreamEvent: subscription(ops.subscribe('chat-stream-event', (_event, eventData) => eventData)),
        interruptChatRequest: query((request) => ops.invoke('interrupt-chat-request', request)),
        ...
        updateStudyLogEntry: query((payload) => ops.invoke('update-study-log-entry', payload)),
        deleteStudyLogEntry: query((payload) => ops.invoke('delete-study-log-entry', payload)),
        deleteStudyDiaryWallCard: query((payload) => ops.invoke('delete-study-diary-wall-card', payload)),
